...
Нужно дописать.
 ...
 - чтобы пуля при инициализации имела нужное направление спрайта (готово)
 - чтобы пуля двигалась с нужной скоростью (готово)
 - чтобы пуля удалялась при выходе за край экрана (готово)
 - чтобы при столкновении с астероидом пуля взрывалась (готово)
