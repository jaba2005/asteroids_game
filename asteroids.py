...
Нужно написать.
 ...
 - генерацию астероидов с выбором случайных спрайтов (готово)
 - непосредственно сам полет астероидов (готово)
 - удаление астероида при столкновении его с пулей (готово)
 - использование хитбокса для удаления
